...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 16 2017 г., 15:03
...
('root', '2017-03-23 16:58:48', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `login` varchar(35) CHARACTER SET cp1251 NOT NULL,
  `password` varchar(35) CHARACTER SET cp1251 DEFAULT NULL,
  `salt` int(3) NOT NULL,
  `permissions` int(2) NOT NULL DEFAULT '2',
  `block` int(2) NOT NULL DEFAULT '0',
  `restriction` int(2) NOT NULL DEFAULT '0'
...
INSERT INTO `users` (`id`, `login`, `password`, `salt`, `permissions`, `block`, `restriction`) VALUES
(1, 'ADMIN', '419b2c50d8fdcda7d0ad8328a3758ccf', 408, 1, 0, 0),
(4, 'New', 'a77f8cb14808fa5170e94f0896989abd', 414, 2, 0, 0),
(6, 'kkk', '9785633e02ac8594174fbd7994a56fb9', 166, 2, 0, 0);
